...
def generate_launch_description():
    ...
    controller_yaml_mule_1 = os.path.join(get_package_share_directory(
        'path_planner_server'), 'config', 'controller_mule_1.yaml')
    bt_navigator_yaml_mule_1 = os.path.join(get_package_share_directory(
        'path_planner_server'), 'config', 'bt_navigator_mule_1.yaml')
    planner_yaml_mule_1 = os.path.join(get_package_share_directory(
        'path_planner_server'), 'config', 'planner_server_mule_1.yaml')
    recovery_yaml_mule_1 = os.path.join(get_package_share_directory(
        'path_planner_server'), 'config', 'recovery_mule_1.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='controller_server',
            output='screen',
            parameters=[controller_yaml_mule_1]),
        ...
        Node(
            ...
            name='planner_server',
            output='screen',
            parameters=[planner_yaml_mule_1]),
        ...
        Node(
            ...
            executable='behavior_server',
            name='behavior_server',
            parameters=[recovery_yaml_mule_1],
            output='screen'),
        ...
        Node(
            ...
            name='bt_navigator',
            output='screen',
            parameters=[bt_navigator_yaml_mule_1]),


        Node(
            package='nav2_lifecycle_manager',
            executable='lifecycle_manager',
            name='mule_1_lifecycle_manager_pathplanner',
            output='screen',
            parameters=[{'autostart': True},
                        {'bond_timeout': 0.0},
                        {'node_names': [
                            'mule_1/planner_server',
                            'mule_1/controller_server',
