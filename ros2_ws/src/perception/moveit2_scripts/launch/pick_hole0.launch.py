...
def generate_launch_description():
    sim_moveit_config = MoveItConfigsBuilder("name", package_name="arm_sim").to_moveit_configs()
    real_moveit_config = MoveItConfigsBuilder("name", package_name="arm_real").to_moveit_configs()
